<?php
// send-guidance-credentials.php - SIMPLIFIED WORKING VERSION
...
try {
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <p>Your Guidance account has been successfully created in the Smart Attendance System.</p>
    ...
    $plainText = "Hello $firstName,\n\n" .
        "Your Guidance account has been created in the Smart Attendance System.\n\n" .

...
try {
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <p>Your Student account has been successfully created in the Smart Attendance System.</p>
    ...
    $plainText = "Hello $firstName,\n\n" .
        "Your Student account has been created in the Smart Attendance System.\n\n" .
